...
public class BatchConfig
{
    ...
    {
        /*
        Another simpler option here is to use JPAItemWriter instead - since we are already using JPA, we can avoid
        having to create the insert statement, and just use JPAItemWriter to insert directly into the db
         */
